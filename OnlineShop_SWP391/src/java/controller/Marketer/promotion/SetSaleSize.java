 ...
 * @author LENNOVO
 */
@WebServlet(name = "SetSaleSize", urlPatterns = {"/SetSaleSize"})
public class SetSaleSize extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<DiscountedProducts> listDP = pd.getDiscountedProductsByPromotionIDAndProductID(Integer.parseInt(promotionID), Integer.parseInt(productID));
        request.setAttribute("DiscountedProducts", listDP);
        request.setAttribute("PromotionForEdit", p);
        request.setAttribute("products", listPro);
        request.setAttribute("sizeOfProduct", listSize);
        request.getRequestDispatcher("SetSaleSize.jsp").forward(request, response);
    }

                ...
                <div id="wrapper">
                    <div id="content-wrapper">
                        <div class="container-fluid">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <form action="SetSaleProduct" method="POST">
                                        <!-- Product ID (hidden) -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="productName" name="productName" value="${product.productName}" class="form-control" readonly />
                                        </div>
                                        <div class="form-group">
                                            <!-- Product Image -->
                                            <c:forEach items="${sessionScope.images}" var="i">
                                                <c:if test="${i.productID==product.productID}">
                                                    ...
                                                    <img src="${pageContext.request.contextPath}/assets/images/products/${i.productImgUrl}" alt="Product Image" class="img-fluid" />
                                        ...
                                        <c:forEach items="${promotions}" var="pr">
                                            <c:if test="${product.productID == pr.productID}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="purchasePrice" name="purchasePrice" value="${product.price}" class="form-control" readonly />
                                                </div>

                                                <!-- Sale Price -->
                                                <div class="form-group">
                                                    <label for="salePrice">Sale Price</label>
                                                    <input type="text" id="salePrice" name="salePrice" value="${product.price - (product.price * pr.discountPercentage / 100)}" class="form-control" readonly />
                                                </div>
                                                <!-- Discount Percentage -->
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="discountPercentage" name="discountPercentage" class="form-control" min="0" max="100"  value="${pr.discountPercentage}" required />
                                                </div>
                                            </c:if>

 ...
 * @author LENNOVO
 */
@WebServlet(name = "SetDefaultAddressServlet", urlPatterns = {"/SetDefaultAddressServlet"})
public class SetDefaultAddressServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Address address = ad.getAddressByAddressID(Integer.parseInt(addressID));
            String primeAddress = customers.getAddress();
            if (address != null) {
                ad.updatedPrimaryAddress(address.getAddressName(), customers.getCustomerID());
                ad.updatedAddress(Integer.parseInt(addressID), primeAddress);
            }

...
public class RemoveDiscountedProduct extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean isDeleted = pd.deleteDiscountedProduct(Integer.parseInt(productID), Integer.parseInt(promotionID));
             String message = isDeleted ? "Deleted Successfully" : "Deleted Failed";
                request.getSession().setAttribute("messageEditPro", message);
                response.sendRedirect("promotion-edit?proid=" + promotionID);
        }
    } 

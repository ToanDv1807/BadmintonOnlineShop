...
import com.oracle.wls.shaded.org.apache.xml.utils.res.IntArrayWrapper;
 ...
 * @author LENNOVO
 */
@WebServlet(name = "SliderDetail", urlPatterns = {"/slider-detail"})
public class SliderDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Slider s = md.getSliderBySID(Integer.parseInt(sid_raw));

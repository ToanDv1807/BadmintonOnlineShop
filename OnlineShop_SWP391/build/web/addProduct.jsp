                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="container update-container">
                                    <div class="card-body">
                                        <form class="updateProductForm" action="AddProductServlet" method="POST" enctype="multipart/form-data">
                                            <!-- Product ID (hidden) -->
                                            ...
                                            <input type="text" id="productBriefInfo" name="productBriefInfo"  required />
                                            <!-- Product Description -->

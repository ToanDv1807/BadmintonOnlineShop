...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container">
            <div class="back">
                <a href="employeelist?pageE=${sessionScope.currentPageE}" class="btn btn-dark">
                            ...
                            <div class="profile-card">
                                ...
                                <c:if test="${c.gender ==1}">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-input form-control" name="email" id="email" value="Male" readonly />
                                ...
                                <c:if test="${c.gender ==0}">
                                    <div class="form-group">
                                        <label for="Gender">Gender: </label>
                                        <input type="email" class="form-input form-control" name="email" id="email" value="Female" readonly />
                                    </div>
                                </c:if>
                                <div class="form-group">
                                    <label for="role">Role: </label>
                                    <c:forEach items="${r}" var="r">
                                        <c:if test="${r.roleID==c.roleID}">
                                            <input type="email" class="form-input form-control" name="email" id="email" value="${r.roleName}" readonly />
                                        </c:if>
                                    </c:forEach>
                                </div>
                                <c:if test="${c.status ==1}">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-input form-control" name="email" id="email" value="On Working" readonly />
                                ...
                                <c:if test="${c.status ==0}">
                                    <div class="form-group">
                                        <label for="Gender">Status: </label>
                                        <input type="email" class="form-input form-control" name="email" id="email" value="Suspended" readonly />
                                    </div>
                                </c:if>

...
public class SellerDashboard extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (checkSessionAndRole(request, response)) {
            ...
            if (!startDate.isAfter(endDate)) {
                listDailyRevenue = s.listDailyRevenueByEmployee(a.getEmployeeID(), startDateStr, endDateStr);
                getOrderTrend = s.getOrderTrend(a.getEmployeeID(), startDateStr, endDateStr);
                totalRevenue = s.getTotalRevenueForSeller(a.getEmployeeID(), startDateStr, endDateStr);
            } else {
    ...
    public String getServletInfo() {
        return "Seller Dashboard Servlet";
    }
}

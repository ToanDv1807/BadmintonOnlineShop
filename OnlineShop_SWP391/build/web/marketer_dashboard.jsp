...
<html>
    ...
    if (successMessage != null) {
                ...
                <div class="dashboard-cards">
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-value">${sessionScope.totalFeedbacks}</div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-value"><fmt:formatNumber value="${sessionScope.totalIncome}" type="currency" currencySymbol="đ" />
                            </div>
            ...
            <div id="product-list-content" class="content-section">
                ...
                <!-- Viết Code Vào Đây  --> 
                <jsp:include page="common/marketer/productManagement.jsp"/>
                <!-- /.content-wrapper -->
            ...
            <div id="promotion-list-content" class="content-section">
                <!-- Nội dung feedback list -->
                <div class="header">
                    <div class="logo">
                        <img alt="Logo" height="40" src="${pageContext.request.contextPath}/assets/images/icons/bfae95351def7e27a2c8c239fdeeac2a.jpg" width="40"/>
...
// Check if there's a saved active section and display it
        ...
        function confirmLogout() {
            ...
            if (confirmed) {
                // Clear the active section from session storage

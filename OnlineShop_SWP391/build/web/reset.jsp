...
<html lang="en">
    ...
    <head>
        ...
        <title>Reset Password - Online Badminton shop</title>
            ...
            <div class="register-card">
                ...
                <form action="reset-password" method="post">
                    ...
                    <div class="form-group">
                        <label class="tieude" for="newPassword">New password:</label>
                        <input type="password" id="newPassword" name="newPassword" required/>
                    </div>
                    <div class="form-group">
                        <label class="tieude" for="confirmPassword">Confirm password:</label>
                        <input type="password" id="confirmPassword" name="confirmPassword" required/>
                    </div>
                    <input class="btn-dark" type="submit" value="Đặt lại mật khẩu"/>
                </form>
            </div>
        </div>

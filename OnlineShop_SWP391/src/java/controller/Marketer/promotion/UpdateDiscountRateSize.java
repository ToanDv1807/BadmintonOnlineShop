 ...
 * @author LENNOVO
 */
@WebServlet(name = "UpdateDiscountRateSize", urlPatterns = {"/UpdateDiscountRateSize"})
public class UpdateDiscountRateSize extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean isUpdated = pd.UpdateDiscountRateSize(
            ...
            response.sendRedirect("SetSaleSize?productID="+ productIdStr +"&promotionID=" + promotionIdStr);
        }
    }

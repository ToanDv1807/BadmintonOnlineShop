 ...
 * @author LENNOVO
 */
@WebServlet(name = "EditAddress", urlPatterns = {"/edit-address"})
public class ShippingAddressDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (cidRaw != null && !cidRaw.isEmpty()) {
                ...
                session.setAttribute("customerToGetAddress", customers);

 ...
 * @author LENNOVO
 */
@WebServlet(name = "EditPromotion", urlPatterns = {"/promotion-edit"})
public class EditPromotion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Products> productsForAdd = pd.getProductForAddToPromotion(Integer.parseInt(promotionID));
            List<Product_Attribute_Stock> listSize = pd.getAllProductAttributeStock();
            List<Products> comingSoonPro = pd.getComingSoonProduct();
            ...
            request.setAttribute("productsForAdd", productsForAdd);
            request.setAttribute("ComingSoon", comingSoonPro);

 ...
 * @author LENNOVO
 */
@WebServlet(name = "ViewSaleSize", urlPatterns = {"/ViewSaleSize"})
public class ViewSaleSize extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("ViewSaleSize.jsp").forward(request, response);
    }
